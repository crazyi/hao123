...
function weekday(){
var cl = '';return(cl+'星期'+nStr1[now.getDay()]+'');
}
function cDay(m,d){
...
var sFtv = new Array("0101*元旦","0214 情人节","0308 妇女节","0312 植树节","0401 愚人节","0501 劳动节","0504 青年节","0512 护士节","0601 儿童节","0701 建党节","0801 建军节","0910 教师节","1001*国庆节","1101 万圣节","1108 记者日","1225 圣诞节","0509 母亲节","0617 父亲节")
...
function refreshCalendarClock(){document.layers.liveclock.document.write ( CurentTime())}
function showcal(t) {
...
if (mm < 10) hh+='0'
hh += mm
var str=''+YYMMDD()+'&nbsp;&nbsp;'+solarDay()+'&nbsp;&nbsp;'+weekday()+'&nbsp;&nbsp;<b>'+CurentTime()+'</b>'
if(t==1) document.getElementById('rili').innerHTML=str
else document.getElementById('liveclock').innerHTML=str
setTimeout('showcal(2)',20000)}
